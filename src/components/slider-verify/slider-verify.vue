		...
		<view class="verifyBox">
			...
			<view class="slide-content">
				...
				<view class="slider-pintu">
					<image id="pintuImg" :src="'/static/slider.jpg'" class="pintu"></image>

					<view class="pintukuai" :style="{ top: top + 'px', left: oldx + 'px' }">
						<image :src="'/static/slider.jpg'" :style="{ top: '-' + top + 'px', left: '-' + left + 'px'}"></image>
					</view>
...
.slider-movearea {
	...
	movable-area {
		...
		movable-view {
			...
			background-image: url(/static/tag-0.png);
