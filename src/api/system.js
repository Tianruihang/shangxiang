import {aiRequest, httpRequests, httpTokenRequest, httpTokenRequests} from './request'
import website from '@/config/website'
import { setStorage, getStorage, removeStorage } from "@/utils/storage";

//登陆接口
export const loginBySocialApi = (params) => {
	let opts ={
		url: '/api/blade-auth/token?grantType=wxmini',
		method: 'post',
	}
    //将params内数据拼接到url上
    let url = opts.url;
